...
highlight String guibg=DarkRed guifg=Yellow
highlight String ctermbg=DarkRed ctermfg=Yellow
...
highlight Number guibg=DarkRed guifg=Yellow
highlight Number ctermbg=DarkRed ctermfg=Yellow
...
highlight Type guibg=DarkRed guifg=Cyan
highlight Type ctermbg=DarkRed ctermfg=Cyan
